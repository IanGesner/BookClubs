namespace BookClubs.Migrations
{
    ...
    public partial class AddedReplyModel : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.GroupWallPosts", t => t.OriginalPostId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.GroupWallPostReplies", "PosterId", "dbo.AspNetUsers");
            DropForeignKey("dbo.GroupWallPostReplies", "OriginalPostId", "dbo.GroupWallPosts");
            ...
            DropIndex("dbo.GroupWallPostReplies", new[] { "PosterId" });
            DropIndex("dbo.GroupWallPostReplies", new[] { "OriginalPostId" });
            ...
            DropTable("dbo.GroupWallPostReplies");
